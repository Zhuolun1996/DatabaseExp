...
urlpatterns = [
    ...
    url(r'^deleteEquipment(?P<PIN_code>\w+)/$', Control_Views.deleteCabinet, name='deleteequipment'),
    ...
    url(r'^changeInnerIP(?P<InnerIP>\S+)/$', Control_Views.changeInnerIP, name='changeinnerip'),
